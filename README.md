# BSWLmod
This is the GitHub repository for my tModLoader (Terraria) mod 'Block's Leveling Mod', which introduces a relatively simple leveling system for weapons (and also players).
